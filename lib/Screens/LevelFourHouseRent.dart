...
class LevelFourHouseRent extends StatefulWidget {
  LevelFourHouseRent({Key? key}) : super(key: key);

  @override
  _LevelFourHouseRentState createState() => _LevelFourHouseRentState();
}

class _LevelFourHouseRentState extends State<LevelFourHouseRent>
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => LevelFourCardLoan()));
                        },
                        child: Container(
